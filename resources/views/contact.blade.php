    ...
    <section class="hero">
        ...
        <div class="container" style="margin-top: 10rem; margin-bottom: 50vh;">
            ...
            <div class="alert alert-error alert-dismissible fade show" role="alert">
                {{ session('error') }}
                <button type="button" class="btnClose" data-bs-dismiss="alert" aria-label="Close">
            ...
            <form action="{{ route('mailbox.tambah') }}" method="post">
                @csrf
                <textarea placeholder="Deskripsi" class="form-control img-fluid" id="deskripsi"  name="description"></textarea>
                <input type="text" name="subject" class="form-control img-fluid" placeholder="Subject" id="subject">
                <input type="text" name="name" class="form-control img-fluid" placeholder="Nama" id="nama">
                <input type="text" name="email"class="form-control img-fluid" placeholder="Email" id="email">
